  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
              <div className="relative group">
                ...
                <div className="relative flex gap-2 p-2 bg-card border-2 border-border rounded-2xl shadow-strong">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto pt-8">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground mt-1">Cidades</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent">15k+</div>
                <div className="text-sm text-muted-foreground mt-1">Alunos</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-4xl font-bold">Explore as Modalidades</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8 p-12 rounded-3xl bg-gradient-hero shadow-strong">
